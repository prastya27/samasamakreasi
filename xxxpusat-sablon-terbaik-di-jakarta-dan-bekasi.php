  ...
  <main id="main">
	...
	<?php
		...
		?>
			...
			$querykux = mysqli_query($con, "select * from tb_galery where fjenis = '$fjenis'");
      ...
      <div class="container text-center">
        ...
        <div class="section-title">
		  ...
		  -->
				...
				<?php
			$per_page = 12;	
			$queryku = mysqli_query($con, "select * from tb_testimonial where fscore > 3 order by fid asc");
